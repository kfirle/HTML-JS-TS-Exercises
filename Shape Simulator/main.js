function main() {
    var shape_code = prompt("Select a shape: \n 1) Square \n 2) Rectangle \n 3) Triangle");
    var shape;
    var length;
    switch (shape_code) {
        //Square
        ...
        //Recatngle
        case '2':
            var height = +prompt("Insert recatngle height");
            if (isNaN(height) || height <= 0 || Math.round(height) != height) {
                throw Error("Error. Please enter a positive integer number.");
            }
            var width = +prompt("Insert recatngle width");
    ...
    var content = prompt("Select shape content: \n 1) * * * * * \n 2) *        * \n 3) 1 2 3 4 5 \n 4) 5 4 3 2 1");
    switch (content) {
        case '1':
